            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="foundation" name="foundation"
                              class="form-control @error('foundation') is-invalid @enderror"></textarea>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="intermediate" name="intermediate"
                              class="form-control @error('intermediate') is-invalid @enderror"></textarea>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="advanced" name="advanced"
                              class="form-control @error('advanced') is-invalid @enderror"></textarea>
